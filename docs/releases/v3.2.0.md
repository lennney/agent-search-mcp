...
- The retained 16-adapter candidate passed packed-install, doctor, launcher,
  stdio, and tool-discovery smoke on Windows and Linux x64 with Node 18.20.8,
  20.20.2, and 22.23.1.
- The exact commit, SHA-256, packed contents, and six-cell matrix are retained
  in [the candidate evidence](../evidence/2026-07-26-release-candidate-0c89ec1.md).
